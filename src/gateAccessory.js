...
class TahomaGateAccessory {
  ...
  async setTargetState(value) {
    ...
    try {
      ...
      // Optimiste : on change l’état courant pour refléter l’action
  ...
  async getCurrentState() {
    // TODO : récupérer l’état réel via API (polling ou cache)
    // Pour l'instant on renvoie l’état stocké
